...
urlpatterns = patterns(
    ...
    url(r'^regions/(?P<pk>[0-9]+)/derived-activities', views.RegionDerivedActivities.as_view(), name='derived-activities'),
    ...
    url(r'^countries/(?P<pk>[a-zA-z]+)/activities', views.ActivitiesInCountryList.as_view(), name='activities'),
)
